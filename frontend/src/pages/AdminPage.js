  ...
  return (
    <div className="page-container admin-page">
      <div className="container-fluid px-4">
        <h2 className="h4 mb-4 admin-page-title">管理后台</h2>
            ...
            <div className="col-md-4">
              <div className="card border-0 shadow-sm">
                <div className="card-body">
                  <h6 className="admin-card-label">用户</h6>
                  <p className="display-6 mb-0 admin-card-value">{stats.users?.total}</p>
                  <small className="admin-card-sub">今日新增：{stats.users?.new_today}</small>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card border-0 shadow-sm">
                <div className="card-body">
                  <h6 className="admin-card-label">检测图片</h6>
                  <p className="display-6 mb-0 admin-card-value">{stats.images?.total}</p>
                  <small className="admin-card-sub">今日上传：{stats.images?.new_today}</small>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card border-0 shadow-sm">
                <div className="card-body">
                  <h6 className="admin-card-label">类别计数（检测结果条数）</h6>
                  <ul className="mb-0 small admin-card-list">
                    {stats.classes &&
